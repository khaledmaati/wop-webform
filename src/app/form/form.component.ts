...
export class FormComponent {
  ...
  addForm(): void {
    const dynamicForm = this.fb.group({
      vertragsnummer: [{ value: '', disabled: true }, Validators.required],
      abschlussdatum: [{ value: '', disabled: true }, Validators.required],
      bausparsumme:   [{ value: '', disabled: true }, Validators.required],
      bausparbeitrag: [{ value: '', disabled: true }, Validators.required],
      hoechstbetrag:  [{ value: '', disabled: true }, Validators.required],
      vermoegenswirksameLeistungen: [{ value: '', disabled: true }, Validators.required]
    });
